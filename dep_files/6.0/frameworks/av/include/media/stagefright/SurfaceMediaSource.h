...
#ifdef DCC_WRITEBACK_ENABLE
    SurfaceMediaSource(uint32_t bufferWidth, uint32_t bufferHeight, uint32_t usage = 0);
#endif
#ifdef ROCKCHIP_GARNET_VPU_ENABLE
    SurfaceMediaSource(uint32_t bufferWidth, uint32_t bufferHeight, uint32_t flags);
#endif
